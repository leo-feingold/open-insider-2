...
def plotData(df, combo):    
    ...
    plt.suptitle(f'2022 Correlation between S&P 500 and Strategy ROI')
...
def main():
    sp500 = "/Users/leofeingold/Desktop/open insider 2/sp500_monthly_performance_2022.csv"
    insiders = "/Users/leofeingold/Desktop/open insider 2/2022_returns_by_month.csv"
